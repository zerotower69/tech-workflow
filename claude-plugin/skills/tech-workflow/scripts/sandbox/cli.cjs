...
function usage() {
  return `技术塔可迁移工作流沙箱\n\n` +
    `用法：\n` +
    `  tech-workflow-sandbox create <slug> [--root <dir>] [--title <text>]\n` +
    `  tech-workflow-sandbox status [dir] [--json]\n` +
    `  tech-workflow-sandbox validate [dir] [--strict] [--json]\n` +
    `  tech-workflow-sandbox revise <artifact> [dir] [--path <file>] [--spec-revision <n>]\n` +
    `  tech-workflow-sandbox approve <artifact> [dir] [--skip-reason <text>]\n` +
    `  tech-workflow-sandbox conflict-add <id> <description> [dir] [--sources <a,b>]\n` +
    `  tech-workflow-sandbox conflict-resolve <id> <decision> [dir]\n` +
    `  tech-workflow-sandbox transition <target> [dir]\n` +
    `  tech-workflow-sandbox rollback <target> [dir] --reason <text>\n` +
    `  tech-workflow-sandbox handoff [dir]\n` +
    `  tech-workflow-sandbox migrate-repo [dir]\n` +
    `  tech-workflow-sandbox verify-repositories [dir]\n` +
    `  tech-workflow-sandbox record-commit <json> [dir]\n` +
    `  tech-workflow-sandbox record-review <json> [dir]\n` +
    `  tech-workflow-sandbox lock-skill <name> <path> [dir] [--version <v>] [--source <uri>]\n` +
    `  tech-workflow-sandbox pack [dir] --output <file.tws>\n` +
    `  tech-workflow-sandbox restore <file.tws> --output <dir> [--workspace-root <dir>]\n`;
}
